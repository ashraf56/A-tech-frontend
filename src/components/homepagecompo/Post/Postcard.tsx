...
const Postcard = () => {
    return (
        <div>
            <Card className="w-full max-w-2xl rounded-2xl mx-auto">
                <CardHeader>
                ...
                <CardContent>
                    <CardTitle className="text-3xl">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta,</CardTitle>
                    ...
                    <CardDescription className="py-5 ">
                        <Image src={img} width={500} height={200} alt="postimg" className="rounded-lg mx-auto" />
                    </CardDescription>
